    ...
    <section className="container">
      <div>
        <Container maxWidth="sm">
          ...
          <br/>
          <Typography className="pageText--body">This site is by <a href="https://unegma.com" target="_blank">Unegma LTD</a> who are not currently affiliated directly with the Ethereum Foundation.</Typography>
          <br/>
